// src/app/recipes/roast-chicken/page.tsx
...
const RECIPE_SLUG = "roast-chicken";
...
export const metadata: Metadata = {
  ...
  description:
    "Herb–chilli yogurt–marinated roast chicken with crisp skin and a simple tray sauce. Minimal fuss, big flavour.",
  openGraph: {
    title: `${recipe.title} – giuseppe.food`,
    description:
      "Herb–chilli yogurt–marinated roast chicken with crisp skin and a simple tray sauce. Minimal fuss, big flavour.",
          ...
          <div>
            ...
            <div className="space-y-5 text-center md:text-left">
              ...
              <p className="text-sm md:text-base text-slate-600 max-w-xl mx-auto md:mx-0">
                Chicken pieces marinated in yogurt, herbs and chilli, then
                roasted hot so the skin goes crisp and the tray fills with a
                ready-made sauce. Proper comfort food, barely any effort.
              </p>
              ...
              <p className="text-[11px] text-slate-500">
                Different oven, different tray, different size of chicken? Hit
                the AI button and ask for timings, swaps or lighter versions.
              </p>
            </div>
              ...
              <div className="group relative rounded-3xl border border-slate-200 bg-white/90 backdrop-blur shadow-sm overflow-hidden">
                ...
                <div className="p-4 space-y-2">
                  ...
                  <p className="text-xs text-slate-600">
                    Marinade does all the work: tender meat, crispy edges and a
                    tray full of flavour to spoon over at the end.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section>
          <div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-[11px] text-slate-500">
                For dark meat, check at the thickest part near the bone: no
                pink, juices running clear. If you&apos;re unsure, use a
                thermometer or ask the AI for exact temps.
              </p>
            </div>
          </div>
        </section>
          ...
          <div>
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-2">
              ...
              <p className="text-[11px] text-slate-500 max-w-md">
                Any oven and any tray will do. These are just the bits that
                make roast chicken a bit easier and more predictable.
              </p>
            </div>

            <div className="grid gap-4 sm:grid-cols-3 text-sm">
              <GearCard
                title="Sturdy roasting tray"
                body="A heavy tray helps the chicken colour evenly and keeps all the juices in one place."
                query="roasting tray non stick"
              />
              <GearCard
                title="Oven-safe rack"
                body="Lifts the chicken slightly so the heat can move around and the skin goes extra crisp."
                query="oven safe roasting rack"
              />
              <GearCard
                title="Instant-read thermometer"
                body="Takes the guesswork out of chicken. Check the thickest part and relax."
            ...
            <div className="space-y-3 text-sm text-slate-800">
              <div className="rounded-2xl border border-slate-200 bg-white/80 p-3">
                ...
                <p className="text-sm text-slate-700 mt-1">
                  You can, but breast cooks quicker and dries out faster. If you
                  want timings for just breasts, or a mix of pieces, ask the AI
                  to adjust the oven time for what you&apos;re using.
                </p>
              </div>
              <div className="rounded-2xl border border-slate-200 bg-white/80 p-3">
                <p className="font-medium text-slate-900">
                ...
                <p className="text-sm text-slate-700 mt-1">
                  Less chilli powder and fewer fresh chillies for a softer
                  version. For more heat, add extra chilli powder or a hot sauce
                  drizzle at the end. The AI can give you a mild or extra hot
                  version in seconds.
                </p>
              </div>
            </div>
