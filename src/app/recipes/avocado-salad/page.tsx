// src/app/recipes/avocado-salad/page.tsx
...
const RECIPE_SLUG = "avocado-salad";
...
export const metadata: Metadata = {
  ...
  description:
    "Simple avocado salad with tomatoes, cucumber and a sharp lemon–oregano dressing. Fresh, quick and works with nearly anything.",
  openGraph: {
    title: `${recipe.title} – giuseppe.food`,
    description:
      "Simple avocado salad with tomatoes, cucumber and a sharp lemon–oregano dressing. Fresh, quick and works with nearly anything.",
...
export default function AvocadoSaladPage() {
  if (!recipe) {
    notFound();
  }
          ...
          <div>
            ...
            <div className="space-y-5 text-center md:text-left">
              ...
              <p className="text-sm md:text-base text-slate-600 max-w-xl mx-auto md:mx-0">
                Soft avocado, crunchy veg and a sharp, herby dressing. It takes
                minutes and works next to chicken, fish, pasta – or just on its
                own with bread.
              </p>
              ...
              <p className="text-[11px] text-slate-500">
                Want it bigger, spicier or without onions? Hit the AI button
                and ask for a version that fits what you like and what you have.
              </p>
            </div>
              ...
              <div className="group relative rounded-3xl border border-slate-200 bg-white/90 backdrop-blur shadow-sm overflow-hidden">
                ...
                <div className="p-4 space-y-2">
                  ...
                  <p className="text-xs text-slate-600">
                    The idea is simple: good olive oil, sharp acid, a bit of
                    herb and crunch. The AI can help scale it up for a crowd.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-xs text-slate-500">
                Don&apos;t stress the exact grams. Use this as a guide and taste
                the dressing as you go.
              </p>
            ...
            <div className="space-y-4">
              ...
              <p className="text-[11px] text-slate-500">
                Add the dressing, toss gently and taste. If it feels flat, add a
                touch more salt, lemon or vinegar.
              </p>
            </div>
          </div>
        </section>
          ...
          <div>
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-2">
              ...
              <p className="text-[11px] text-slate-500 max-w-md">
                You can make this with just a knife and a bowl. These are nice
                extras if you want to upgrade your setup.
              </p>
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-3 text-sm">
              <GearCard
                ...
                body="Makes slicing the avocado and veg easy instead of a fight."
                query="chef knife 20cm"
              />
              <GearCard
                title="Small mixing bowl"
                body="Handy for whisking the dressing before it goes on the salad."
                query="small glass mixing bowl set"
              />
              <GearCard
                title="Olive oil bottle"
                body="A spout bottle makes it easier to drizzle just the right amount."
                query="olive oil dispenser bottle"
              />
            </div>
            ...
            <div className="space-y-3 text-sm text-slate-800">
              <div className="rounded-2xl border border-slate-200 bg-white/80 p-3">
                ...
                <p className="text-sm text-slate-700 mt-1">
                  Best fresh, because avocado browns. If you want to prep ahead,
                  chop everything except the avocado and dressing, then mix and
                  slice the avocado right before you eat. Or ask the AI for a
                  “meal prep” version that holds better.
                </p>
              </div>
              <div className="rounded-2xl border border-slate-200 bg-white/80 p-3">
                <p className="font-medium text-slate-900">
                ...
                <p className="text-sm text-slate-700 mt-1">
                  Use less, slice it very thin, or leave it out. You can swap it
                  for spring onion, or ask the AI for a no-onion version with
                  the same vibe.
                </p>
              </div>
            </div>
        ...
        <section>
          <div>
            <div className="flex flex-wrap items-center justify-between gap-3 border-t border-slate-200 pt-6">
              <p className="text-xs text-slate-500">
                Want to cook something bigger after this? There are more ideas
                on the main recipes page.
              </p>
              <Link
                href="/recipes"
