// src/app/recipes/apple-cake/page.tsx
...
export const metadata: Metadata = {
  ...
  description:
    "Easy one-bowl apple cake. Melt, mix, bake – soft apples, light sponge and zero stress.",
  openGraph: {
    title: `${recipe.title} – giuseppe.food`,
    description:
      "Easy one-bowl apple cake. Melt, mix, bake – soft apples, light sponge and zero stress.",
...
export default function AppleCakePage() {
  if (!recipe) {
    notFound();
  }
          ...
          <div>
            <div className="space-y-5 text-center md:text-left">
              ...
              <p className="text-sm md:text-base text-slate-600 max-w-xl mx-auto md:mx-0">
                This is that easy apple cake you make once and then keep making.
                No mixer, no drama – just melt, whisk, fold and bake.
              </p>
              ...
              <p className="text-[11px] text-slate-500">
                Need it without alcohol, less sweet or in a different tin size?
                Hit the AI button and it can scale and tweak it for you.
              </p>
            </div>
              ...
              <div className="group relative rounded-3xl border border-slate-200 bg-white/90 backdrop-blur shadow-sm overflow-hidden">
                ...
                <div className="p-4 space-y-2">
                  ...
                  <p className="text-xs text-slate-600">
                    Thin sliced apples tucked into a light batter. Easy to serve
                    warm with cream, ice cream or just on its own.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div>
            <div className="space-y-4">
              ...
              <p className="text-xs text-slate-500">
                Use eating apples you like. If they&apos;re very sweet, you can
                shave a little sugar off.
              </p>
            ...
            <div className="space-y-4">
              ...
              <p className="text-[11px] text-slate-500">
                Every oven is different. If the top is dark but the centre isn&apos;t
                set, loosely cover with foil and bake a bit longer.
              </p>
            </div>
          </div>
        </section>
          ...
          <div>
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-2">
              ...
              <p className="text-[11px] text-slate-500 max-w-md">
                You can bake this in any similar sized tin. These are just the
                kind of things that make life easier.
              </p>
            </div>

            <div className="grid gap-4 sm:grid-cols-3 text-sm">
              <GearCard
                title="20 cm cake tin"
                body="A small round tin gives you a nice, tall cake with soft slices."
                query="20cm round cake tin non stick"
              />
              <GearCard
                title="Baking parchment"
                body="Lining the tin makes it simple to lift the cake out in one piece."
                query="baking parchment paper roll"
              />
              <GearCard
                title="Digital kitchen scales"
                body="Makes it easy to hit the gram measurements without guessing."
                query="digital kitchen scales grams"
              />
            </div>
            ...
            <div className="space-y-3 text-sm text-slate-800">
              <div className="rounded-2xl border border-slate-200 bg-white/80 p-3">
                ...
                <p className="text-sm text-slate-700 mt-1">
                  Yes. Just leave it out or swap for a splash of milk or juice.
                  If you want the AI to give you a version for kids or for a
                  specific tin, ask it with the button above.
                </p>
              </div>
              <div className="rounded-2xl border border-slate-200 bg-white/80 p-3">
                <p className="font-medium text-slate-900">
                ...
                <p className="text-sm text-slate-700 mt-1">
                  A skewer in the centre should come out without wet batter. A
                  few soft crumbs are fine. If it&apos;s still liquid, give it
                  more time.
                </p>
              </div>
            </div>
        ...
        <section>
          <div>
            <div className="flex flex-wrap items-center justify-between gap-3 border-t border-slate-200 pt-6">
              <p className="text-xs text-slate-500">
                After dessert, there&apos;s plenty more to cook. Check the other
                recipes here.
              </p>
              <Link
                href="/recipes"
