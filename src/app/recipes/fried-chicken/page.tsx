// src/app/recipes/fried-chicken/page.tsx
...
const RECIPE_SLUG = "fried-chicken";
...
export const metadata: Metadata = {
  ...
  description:
    "Crispy, juicy fried chicken marinated in buttermilk then dredged in spiced flour and fried until golden.",
  openGraph: {
    title: `${recipe.title} – giuseppe.food`,
    description:
      "Crispy, juicy fried chicken marinated in buttermilk then dredged in spiced flour and fried until golden.",
...
export default function FriedChickenPage() {
  if (!recipe) {
    notFound();
  }
          ...
          <Reveal className="grid gap-8 lg:grid-cols-[minmax(0,3fr)_minmax(0,2fr)] items-start">
            ...
            <div className="space-y-5 text-center md:text-left">
              ...
              <p className="text-sm md:text-base text-slate-600 max-w-xl mx-auto md:mx-0">
                This is proper fried chicken: buttermilk to tenderise, seasoned
                flour for crunch, and a hot pan of oil to get that golden crust.
              </p>
              ...
              <p className="text-[11px] text-slate-500">
                Want to bake instead, switch to wings only or match a specific
                spice blend? Ask the AI and it can rework the method for you.
              </p>
            </div>
              ...
              <div className="group relative rounded-3xl border border-slate-200 bg-white/90 backdrop-blur shadow-sm overflow-hidden">
                ...
                <div className="p-4 space-y-2">
                  ...
                  <p className="text-xs text-slate-600">
                    The combo is simple: overnight buttermilk, seasoned flour,
                    then a calm, steady fry until crisp.
                  </p>
                </div>
              </div>
            </div>
          ...
          <Reveal className="grid gap-10 md:grid-cols-[minmax(0,1.2fr)_minmax(0,1.4fr)] items-start">
            ...
            <div className="space-y-4">
              ...
              <p className="text-xs text-slate-500">
                You can tweak the spice mix however you like. The important
                parts are the buttermilk soak and a good flour coating.
              </p>
            ...
            {/* Method (short-hand steps in data, AI is for detail) */}
            <div className="space-y-4">
              ...
              <p className="text-[11px] text-slate-500">
                Keep the oil hot but not smoking. If you want exact oil
                temperatures, timings and internal temps, ask the AI for a fully
                detailed version.
              </p>
            </div>
          </Reveal>
          ...
          <Reveal className="space-y-4">
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-2">
              ...
              <p className="text-[11px] text-slate-500 max-w-md">
                You can fry in any deep pan. These bits just make frying less
                messy and more consistent.
              </p>
            </div>

            <div className="grid gap-4 sm:grid-cols-3 text-sm">
              <GearCard
                title="Deep frying pan or pot"
                body="A deep, heavy pan helps keep the oil temperature steady."
                query="deep frying pan with high sides"
              />
              <GearCard
                title="Oil thermometer"
                body="Lets you keep the oil in the right zone for crisp without burning."
                query="digital deep fry thermometer"
              />
              <GearCard
                title="Wire rack + tray"
                body="Rest the chicken so it stays crisp instead of steaming on a plate."
                query="cooling rack with baking tray"
              />
            </div>
            ...
            <div className="space-y-3 text-sm text-slate-800">
              <div className="rounded-2xl border border-slate-200 bg-white/80 p-3">
                ...
                <p className="text-sm text-slate-700 mt-1">
                  A few hours is good; overnight is great. If you&apos;re in a
                  rush, even 30–60 minutes helps. Ask the AI for a “no
                  buttermilk” version if you don&apos;t have any.
                </p>
              </div>
              <div className="rounded-2xl border border-slate-200 bg-white/80 p-3">
                <p className="font-medium text-slate-900">
                ...
                <p className="text-sm text-slate-700 mt-1">
                  The thickest part should be piping hot with clear juices. A
                  thermometer reading of about 75°C in the centre is ideal. The
                  AI can walk you through this step-by-step if you&apos;re not
                  sure.
                </p>
              </div>
            </div>
        ...
        <section>
          <Reveal>
            <div className="flex flex-wrap items-center justify-between gap-3 border-t border-slate-200 pt-6">
              <p className="text-xs text-slate-500">
                After fried chicken, maybe something lighter. Browse the rest of
                the recipes here.
              </p>
              <Link
                href="/recipes"
