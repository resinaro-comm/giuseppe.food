// src/app/recipes/amaretti/page.tsx
...
export const metadata: Metadata = {
  ...
  description:
    "Chewy almond amaretti with crinkly tops – a few ingredients, big flavour.",
  openGraph: {
    title: `${recipe.title} – giuseppe.food`,
    description:
      "Chewy almond amaretti with crinkly tops – a few ingredients, big flavour.",
...
export default function AmarettiPage() {
  if (!recipe) {
    notFound();
  }
          ...
          <div>
            ...
            <div className="space-y-5 text-center md:text-left">
              ...
              <p className="text-sm md:text-base text-slate-600 max-w-xl mx-auto md:mx-0">
                Soft in the middle, a little crisp on the outside and full of
                almond flavour. You whisk, fold, scoop and bake – that&apos;s
                it.
              </p>
              ...
              <p className="text-[11px] text-slate-500">
                Need to make them without egg whites, less sweet or in a
                different size? Ask the AI and it&apos;ll rewrite the recipe for
                you.
              </p>
            </div>
              ...
              <div className="group relative rounded-3xl border border-slate-200 bg-white/90 backdrop-blur shadow-sm overflow-hidden">
                ...
                <div className="p-4 space-y-2">
                  ...
                  <p className="text-xs text-slate-600">
                    They naturally crack and crinkle on top – that&apos;s the
                    whole charm of them.
                  </p>
                </div>
              </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-xs text-slate-500">
                Only a few ingredients, so good almond flour and a decent
                extract make a big difference.
              </p>
            ...
            <div className="space-y-4">
              ...
              <p className="text-[11px] text-slate-500">
                If you want bigger or smaller amaretti, or a different bake for
                softer vs crisp, ask the AI for updated oven times.
              </p>
            </div>
          </div>
        </section>
          ...
          <div>
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-2">
              ...
              <p className="text-[11px] text-slate-500 max-w-md">
                You can do this with a bowl and a spoon. These just make the
                process neater and more consistent.
              </p>
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-3 text-sm">
              <GearCard
                title="Mixing bowl"
                body="Somewhere to whisk the egg whites and fold everything together."
                query="stainless steel mixing bowl"
              />
              <GearCard
                title="Cookie scoop or small spoon"
                body="Helps you portion the amaretti evenly so they bake the same."
                query="small cookie scoop"
              />
              <GearCard
                title="Baking tray + parchment"
                body="Stops them sticking and keeps the bottoms from browning too fast."
                query="non stick baking tray parchment"
              />
            </div>
            ...
            <div className="space-y-3 text-sm text-slate-800">
              <div className="rounded-2xl border border-slate-200 bg-white/80 p-3">
                ...
                <p className="text-sm text-slate-700 mt-1">
                  The dough should be thick and sticky, not runny. If yours is
                  too loose, add a little extra almond flour. Ask the AI for a
                  precise fix based on what you used.
                </p>
              </div>
              <div className="rounded-2xl border border-slate-200 bg-white/80 p-3">
                <p className="font-medium text-slate-900">
                ...
                <p className="text-sm text-slate-700 mt-1">
                  You can add citrus zest, swap the extract, dip them in
                  chocolate and more. The AI can suggest combos and updated
                  amounts that still keep the texture right.
                </p>
              </div>
            </div>
          </div>
        ...
        <section>
          <div>
            <div className="flex flex-wrap items-center justify-between gap-3 border-t border-slate-200 pt-6">
              <p className="text-xs text-slate-500">
                Want more small sweet things for coffee breaks? Check the rest
                of the baking recipes.
              </p>
              <Link
                href="/recipes"
