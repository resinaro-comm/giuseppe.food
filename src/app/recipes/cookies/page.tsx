// src/app/recipes/cookies/page.tsx
...
export const metadata: Metadata = {
  ...
  description:
    "Soft-centre, crisp-edge cookies with melted chocolate and simple ingredients.",
  openGraph: {
    title: `${recipe.title} – giuseppe.food`,
    description:
      "Soft-centre, crisp-edge cookies with melted chocolate and simple ingredients.",
          ...
          <div>
            ...
            <div className="space-y-5 text-center md:text-left">
              ...
              <p className="text-sm md:text-base text-slate-600 max-w-xl mx-auto md:mx-0">
                Proper bakery-style cookies at home: soft in the middle, crisp
                on the edge, big pockets of melted chocolate. Simple mix, scoop
                and bake.
              </p>
              ...
              <p className="text-[11px] text-slate-500">
                Want them thicker, smaller, or baked from frozen? Hit the AI
                button and let it do the maths for you.
              </p>
            </div>
              ...
              <div className="group relative rounded-3xl border border-slate-200 bg-white/90 backdrop-blur shadow-sm overflow-hidden">
                ...
                <div className="p-4 space-y-2">
                  <p className="text-[11px] uppercase tracking-[0.18em] text-slate-500">
                    Soft centre, crisp edge
                  </p>
                  <p className="text-xs text-slate-600">
                    Mix of brown and white sugar keeps them chewy in the middle
                    with that nice edge crunch.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-xs text-slate-500">
                This base works with most chocolate. The AI can help you swap in
                dark, milk or chunks from a bar.
              </p>
            ...
            <div className="space-y-4">
              ...
              <p className="text-[11px] text-slate-500">
                Pull them when the edges are set but the centre still looks a
                bit soft – they firm up as they cool. The AI can give you exact
                baking times for your oven and tray size.
              </p>
            </div>
          </div>
        </section>
          ...
          <div>
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-2">
              ...
              <p className="text-[11px] text-slate-500 max-w-md">
                You can bake these on any tray. These just help with even bakes
                and less mess.
              </p>
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-3 text-sm">
              <GearCard
                ...
                body="Stops the cookies sticking and helps the bottoms cook evenly."
                query="non stick cookie baking tray parchment"
              />
              <GearCard
                title="Cookie scoop"
                body="Keeps every cookie the same size so they bake at the same speed."
                query="medium cookie scoop"
              />
              <GearCard
                title="Wire cooling rack"
                body="Lets the cookies cool without steaming on the tray."
                query="cooling rack for baking"
              />
            </div>
            ...
            <div className="space-y-3 text-sm text-slate-800">
              <div className="rounded-2xl border border-slate-200 bg-white/80 p-3">
                ...
                <p className="text-sm text-slate-700 mt-1">
                  Chilling helps if your kitchen is hot or you want thicker
                  cookies. Ask the AI for chill times and adjusted bake times
                  based on how thick you want them.
                </p>
              </div>
              <div className="rounded-2xl border border-slate-200 bg-white/80 p-3">
                <p className="font-medium text-slate-900">
                ...
                <p className="text-sm text-slate-700 mt-1">
                  Yes. Freeze dough balls or baked cookies. The AI can give you
                  bake-from-frozen timings so you get fresh cookies on demand.
                </p>
              </div>
            </div>
          </div>
        ...
        <section>
          <div>
            <div className="flex flex-wrap items-center justify-between gap-3 border-t border-slate-200 pt-6">
              <p className="text-xs text-slate-500">
                Still want more baking? There are cakes, crumble and other
                cookies on the main recipes page.
              </p>
              <Link
                href="/recipes"
