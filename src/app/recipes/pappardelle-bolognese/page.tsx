// src/app/recipes/pappardelle-bolognese/page.tsx
...
export const metadata: Metadata = {
  ...
  description:
    "Silky pappardelle tossed in a rich, slow-cooked beef ragù with proper depth of flavour.",
  openGraph: {
    title: `${recipe.title} – giuseppe.food`,
    description:
      "Silky pappardelle tossed in a rich, slow-cooked beef ragù with proper depth of flavour.",
...
export default function PappardelleBolognesePage() {
  if (!recipe) {
    notFound();
  }
          ...
          <Reveal className="grid gap-8 lg:grid-cols-[minmax(0,3fr)_minmax(0,2fr)] items-start">
            ...
            <div className="space-y-5 text-center md:text-left">
              ...
              <p className="text-sm md:text-base text-slate-600 max-w-xl mx-auto md:mx-0">
                Proper slow-cooked ragù: vegetables, beef, wine and tomatoes
                simmered down until thick and glossy, then tossed with wide
                pappardelle.
              </p>
              ...
              <p className="text-[11px] text-slate-500">
                Need to cook it in a slow cooker, pressure cooker or for a big
                group? Ask the AI and it&apos;ll scale and adapt everything.
              </p>
            </div>
              ...
              <div className="group relative rounded-3xl border border-slate-200 bg-white/90 backdrop-blur shadow-sm overflow-hidden">
                ...
                <div className="p-4 space-y-2">
                  ...
                  <p className="text-xs text-slate-600">
                    The longer it simmers, the deeper the flavour. This is
                    proper comfort pasta.
                  </p>
                </div>
              </div>
            </div>
          ...
          <Reveal className="grid gap-10 md:grid-cols-[minmax(0,1.2fr)_minmax(0,1.4fr)] items-start">
            ...
            <div className="space-y-4">
              ...
              <p className="text-xs text-slate-500">
                This is the base. The AI can help you swap wine, use stock
                instead, or add things like pancetta.
              </p>
            ...
            <div className="space-y-4">
              ...
              <p className="text-[11px] text-slate-500">
                Ragù should be thick enough to cling to the pasta, not watery.
                If you&apos;re unsure, ask the AI for tips based on what you&apos;re
                seeing in the pan.
              </p>
            </div>
          </Reveal>
          ...
          <Reveal className="space-y-4">
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-2">
              ...
              <p className="text-[11px] text-slate-500 max-w-md">
                Any big pot works. These just make long simmers and pasta
                cooking easier.
              </p>
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-3 text-sm">
              <GearCard
                title="Heavy-bottomed pot"
                body="Helps the ragù simmer gently without catching on the bottom."
                query="heavy bottomed casserole pot"
              />
              <GearCard
                title="Wooden spoon"
                body="Good for scraping up the browned bits and stirring over time."
                query="wooden cooking spoon set"
              />
              <GearCard
                title="Large pasta pot and colander"
                body="Plenty of space for the pappardelle and easy draining."
                query="large pasta pot with colander"
              />
            </div>
            ...
            <div className="space-y-3 text-sm text-slate-800">
              <div className="rounded-2xl border border-slate-200 bg-white/80 p-3">
                ...
                <p className="text-sm text-slate-700 mt-1">
                  Yes. It freezes really well. The AI can give you cooling,
                  portioning and reheating steps so the texture stays nice.
                </p>
              </div>
              <div className="rounded-2xl border border-slate-200 bg-white/80 p-3">
                <p className="font-medium text-slate-900">
                ...
                <p className="text-sm text-slate-700 mt-1">
                  No – you can swap the wine for extra stock. Ask the AI for a
                  wine-free version with adjusted seasoning so it still tastes
                  rich.
                </p>
              </div>
            </div>
