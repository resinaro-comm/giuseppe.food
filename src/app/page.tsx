    ...
    <div className="space-y-16">
      ...
      <section className="grid gap-10 lg:grid-cols-[minmax(0,3fr)_minmax(0,2fr)] items-center">
        ...
        {heroRecipe && (
          <Link
            ...
            className="group relative rounded-3xl border border-slate-200 bg-white shadow-sm overflow-hidden flex flex-col w-full max-w-xs mx-auto lg:ml-auto lg:mr-0"
          >
      ...
      <section className="space-y-6">
        ...
        <div className="grid gap-6 md:grid-cols-3 max-w-xl mx-auto md:max-w-none">
          <div className="rounded-2xl border border-slate-200 bg-white p-4 space-y-2 text-center md:text-left">
