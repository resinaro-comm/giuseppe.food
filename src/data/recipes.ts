...
export const recipes: Recipe[] = [
  ...
  },
  {
    ...
    shortDescription: "Marinated thigh strips, flour‑coated and fried, then tossed in a quick hot honey butter.",
    timeMinutes: 35,
    ...
    ingredients: [
      ...
      "Salt and black pepper",
      "1 egg",
      "Plain flour (seasoned with herbs/spices)",
  ...
  },
  {
    ...
    ingredients: [
      ...
      "Onion, sliced",
      "Wine (a splash)",
      "Tinned tomatoes – Mutti, 2 tins",
      "Dried herbs (optional) and fresh basil",
